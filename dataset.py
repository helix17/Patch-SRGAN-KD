...
class BaseImageDataset(Dataset):
    ...
    def __init__(
        ...
        if lr_images_dir is None:
            ...
            self.lr_image_file_names = [os.path.join(lr_images_dir, image_file_name_lr) for image_file_name_lr in image_file_names_lr]
            self.gt_image_file_names = [os.path.join(gt_images_dir, image_file_name_gt) for image_file_name_gt in image_file_names_gt]
